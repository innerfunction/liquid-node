  ...
  module.exports = Context = (function() {
    ...
    Context.prototype.lookupAndEvaluate = function(obj, key) {
      if (obj instanceof Liquid.Drop) {
        // NOTE context passed as second arg when resolving values on drops.
    ...
    // Extend the context by instantiating a copy of the context with the
    // new scope object at the head of the scope stack.
    Context.prototype.extend = function( scope ) {
      let ctx = Object.create( this );
      ctx.scopes = [ scope ].concat( this.scopes );
      return ctx;
    }
